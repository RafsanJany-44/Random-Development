...
select msg.chat_group_add('{"org_id": "2","dc_name":"Test","discussion_class": "PUBLIC_GROUP","members":[{"bp_id":"465074","role_code":"$CGOWNER"},{"bp_id":"465075","role_code":"$CGPART"},{"bp_id":"465086","role_code":"$CGADMIN"}]}');


select msg.chat_group_add('{"org_id": "2","dc_name":"MAR RJ MAR","discussion_class": "PUBLIC_GROUP","members":[{"bp_id":"465074","role_code":"$CGOWNER"},{"bp_id":"465075","role_code":"$CGPART"},{"bp_id":"465086","role_code":"$CGADMIN"}]}');
...
select msg.chat_group_add('{"org_id": "2","dc_name":"Jingala","discussion_class": "PUBLIC_GROUP","members":[{"bp_id":"465074","role_code":"$CGOWNER"},{"bp_id":"465075","role_code":"$CGPART"},{"bp_id":"465086","role_code":"$CGADMIN"}]}');



select msg.chat_save(2,14588,'this is the first msg from new function',465086,465075);
